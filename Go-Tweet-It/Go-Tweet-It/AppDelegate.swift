...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(app: UIApplication, openURL url: NSURL, options: [String : AnyObject]) -> Bool {
        ...
        let requestToken = BDBOAuth1Credential(queryString: url.query)// Puts request token that we get while app is running into a variable
        ...
        twitterClient.fetchAccessTokenWithPath("oauth/access_token", method: "POST", requestToken: requestToken, success: {(accessToken:BDBOAuth1Credential!) -> Void in
            ...
            twitterClient.GET("1.1/statuses/home_timeline.json", parameters: nil, progress: nil,
                ...
                }, failure: { (task: NSURLSessionDataTask?, erro: NSError) -> Void in
                    print("Did not get any tweets.")
            })
